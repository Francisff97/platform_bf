...
@section('title', 'Azione non consentita (Demo)')

@section('content')
<div class="min-h-[60vh] flex flex-col items-center justify-center text-center px-6 py-20 bg-gray-50 dark:bg-gray-900">
