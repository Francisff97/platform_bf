  ...
  <div class="mt-[100px] grid grid-cols-2 md:grid-cols-4 gap-6">
    @foreach($coaches as $c)
      <a href="{{ route('coaches.show',$c->slug) }}"
        ...
        <div class="mx-auto h-[120px] w-[120px] overflow-hidden rounded-full bg-gray-200 dark:bg-gray-800 mb-2">
          @if($c->image_path)<img src="{{ Storage::url($c->image_path) }}" class="h-full w-full object-cover" alt="{{ $c->name }}">@endif
        </div>
